...
const StrategySuggestWidget: React.FC<Props> = ({className, chartColor, chartHeight, chartWidth, userId, strategyId, strategyObj, apis , getData=()=>{}, strategys }) => {
